...
| `Generate_Benchmarking_and_Ablation_Study_Figures tutorial.ipynb` | Figure 3 benchmarking and ablation workflow. |

See the `tutorials/` directory in the GitHub repository for executable notebooks.
